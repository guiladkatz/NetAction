...
def main():
    ...
    with open("Exp_1/link_utilization_0_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
    ...
    with open("Exp_2/link_utilization_8_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_3/link_utilization_16_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_4/link_utilization_32_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_5/link_utilization_64_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_6/link_utilization_128_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_7/link_utilization_256_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_8/link_utilization_1024_0_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    ax1.legend(["Cache Size = 8","Cache Size = 16","Cache Size = 1024"],loc='upper left')
    #ax2.legend(["Cache Size = 8","Cache Size = 16","Cache Size = 1024"],loc='upper left')
