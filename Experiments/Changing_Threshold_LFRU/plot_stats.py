...
def main():
    ...
    with open("Exp_1/link_utilization_32_16_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
    ...
    with open("Exp_2/link_utilization_32_32_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_4/link_utilization_32_128_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_5/link_utilization_32_256_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    title ="Cache Size = 32\nController Miss Threshold = Varying\nRandom Rules Sampling Number = 8"
    fig.suptitle(title)
    # make a plot
    ...
    ax1.legend(["Threshold = 16","Threshold = 32","Threshold = 64","Threshold = 128","Threshold = 256"])
    #ax1.legend(["Cache Size = 16","Cache Size = 256"])
