...
def main():
    ...
    with open("Deletions_32_256_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
    ...
    with open("Insertions_32_256_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("link_utilization_32_256_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("traffic_arrival_rate_32_256_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
