...
state_graph graph_0(state_context flow_ctx, parsed_headers_t hdr, 
                    ...
                    Register<16> ports, Register<16> freePortPointer, Register<16> freePortID) {
    state start {
    ...
    state free_port_picked_up {
        if (standard_metadata.ingress_port == INTERNAL) {
            ...
            local_metadata.stage1_fk = local_metadata.l4_dst_port;
        }
    }
}
...
control IngressPipeImpl (inout parsed_headers_t hdr,
    ...
    stateful_table stage_0 {
        ...
        size = 65536;
        idle_timeout = 120000;
        graph = graph_0(flow_ctx, hdr, local_metadata, standard_metadata, ports, freePortPointer);
    }
    ...
    stateful_table stage_1 {
        ...
        size = 65536;
        idle_timeout = 120000;
        graph = graph_1(flow_ctx, hdr, local_metadata, standard_metadata, natIPAddress);
    }
